...
def
static
 toText(Planning root)
'''
        Info of the planning 
«root.name» 
        All Persons:
«
"\n"
...
static
dispatch
 action2Text(LunchAction action)
'''
        Lunch at location 
«action.location»
'''
...
static
dispatch
 action2Text(MeetingAction action)
'''
        Meeting with topic 
«action.topic»
'''
...
static
dispatch
 action2Text(PaperAction action)
'''
        Paper for journal 
«action.report»
'''
...
static
dispatch
 action2Text(PaymentAction action)
'''
        Pay 
«action.amount»
 euro'''
...
def
static
 CharSequence toText(TimeUnit u){ 
switch
(u){ 
case
 TimeUnit::
