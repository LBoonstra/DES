...
void threeLeftUp(void *arg) {
	...
	int period_time = rotation_time- sensor_interrupted_time*2.5; //Adjust on the result of 9a on average sensor
...
void twoLeftUp(void *arg) {
	...
	int period_time = rotation_time - sensor_interrupted_time*1.6; //Adjust on the result of 9a on average sensor
	int sleep_time = sensor_interrupted_time/2;
	value=0;
...
void oneLeftUp(void *arg) {
	...
	int period_time = sensor_interrupted_time *0.5; //Adjust on the result of 9a on average sensor
	int sleep_time = sensor_interrupted_time/2;
	value=0;
...
void oneLeftDown(void *arg) {
	...
	int period_time = sensor_interrupted_time *0; //Adjust on the result of 9a on average sensor
	int sleep_time = sensor_interrupted_time/2;
	value=0;
...
void middle(void *arg) {
	...
	int period_time =  sensor_interrupted_time;//rotation_time; 
	int sleep_time = sensor_interrupted_time/2;
	value=0;
...
void oneRightUp(void *arg) {
	...
	int xeno_trigger=GPIO_TRIGGER_EDGE_FALLING;
	ret=ioctl(fdw4, GPIO_RTIOC_DIR_OUT, &value);
	int period_time =  sensor_interrupted_time*1.5; //Adjust on the result of 9a on average sensor
	int sleep_time = sensor_interrupted_time/2;
	value=0;
	ret = write(fdw4, &value, sizeof(value));
	while(1) {
...
void twoRightUp(void *arg) {
	...
	int xeno_trigger=GPIO_TRIGGER_EDGE_FALLING;
	ret=ioctl(fdw3, GPIO_RTIOC_DIR_OUT, &value);
	int period_time =  sensor_interrupted_time*2.3; //Adjust on the result of 9a on average sensor
	int sleep_time = sensor_interrupted_time/2;
	value=0;
	ret = write(fdw3, &value, sizeof(value));
	while(1) {
...
void threeRightDown(void *arg) {
	...
	int fdw9 = open("/dev/rtdm/pinctrl-bcm2835/gpio9",O_WRONLY);
	ret=ioctl(fdw9, GPIO_RTIOC_DIR_OUT, &value);
	int period_time =  sensor_interrupted_time*4; //Adjust on the result of 9a on average sensor
	int sleep_time = sensor_interrupted_time/2;
	value=0;
	ret = write(fdw9, &value, sizeof(value));
	while(1) {
