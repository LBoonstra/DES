...
static int sensor_interrupted_time = 1680706/2; // 1680706 was measured sensor time: dividing by two makes the x smaller and look better and slightly prevents flashing (one or more leds only lit up once per two cycles).
static int rotation_time = 83500000;//83877270 was measured rotation time: rounding it up slightly improves performance.
